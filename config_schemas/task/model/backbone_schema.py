...
def setup_config() -> None:
    ...
    cs.store(
        group="task/model/backbone",
        name="resnet18_schema",
        node=ResNet18BackboneConfig
    )
    cs.store(
        group="task/model/backbone",
        name="resnet34_schema",
        node=ResNet34BackboneConfig
    )
    cs.store(
        group="task/model/backbone",
        name="resnet50_schema",
        node=ResNet50BackboneConfig
    )